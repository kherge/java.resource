...
Please note that open issues and pull requests that are inactive for 30 days may be labeled as "inactive" and closed. The issue or pull request may only be reopened if new activity is available (e.g. new comment, new/changed commits).

Style Guide
-----------

Code submissions must follow the [Google Java][] coding style guide.
...
When submitting code, please take into consideration the current version of the interpreter supported by the project. The [Requirements][] section of the README has more information.
